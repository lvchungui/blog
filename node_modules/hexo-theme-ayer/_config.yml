...
subtitle:
  enable: true # 是否开启动效
  text: 时间从来不语，却回答了所有问题 # 显示的文字
  text2:  有时候简简单单就好了 # 滚动播放，如果不需要可以留空
  text3: 愿你一生努力，一生被爱 # 最多支持三段文字
  startDelay: 3 # 延迟时间
  typeSpeed: 200 # 打字速度
  loop: true # 是否循环
  backSpeed: 100 # 回退速度
...
cover:
  enable: true
  path: /images/cover2.jpg # /source/images目录下附送多张美图，可更换
...
alipay: /images/支付宝收款码.jpg
# 微信二维码图片地址
weixin: /images/微信收款码.png
