...
music:
  ...
  id: 7676422571     #require	song id / playlist id / album id / search keyword
  fixed: true       # 开启吸底模式
...
reward:
  enable: true
  title: 你的赏识是我前进的动力
  wechat: /medias/微信收款码.png
  alipay: /medias/支付宝收款码.jpg
...
mathjax:
  enable: false
  cdn: https://cdn.bootcss.com/mathjax/2.7.7/MathJax.js?config=TeX-AMS-MML_HTMLorMML
...
libs:
  css:
    ...
    baguetteBoxCss: /libs/MyGallery/baguetteBox.css
  js:
    matery: /js/matery.js
    ...
    baguetteBoxJs: /libs/MyGallery/baguetteBox.js
...
- /medias/featureimages/4.png
- /medias/featureimages/5.jpeg
