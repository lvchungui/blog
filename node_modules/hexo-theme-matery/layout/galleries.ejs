...
<!-- <%- url_for(theme.libs.css.baguetteBox) %>
<%- url_for(theme.libs.js.baguetteBox) %> -->

<!-- <link rel="stylesheet" href="<%- theme.libs.css.baguetteBox %>"> -->
<link rel="stylesheet" href="../source/libs/MyGallery/baguetteBox.css">
<!-- 该主题自带的lightGallery.js在图片多的时候会很卡，所以弃用，使用了一个我在网上找的baguetteBox，很轻量级，就是功能少了点 -->
<!-- <script src="<%- theme.libs.js.baguetteBox %>"></script>  -->
<script src="../source/libs/MyGallery/baguetteBox.js"></script>
<script src="../source/libs/MyGallery/jquery-1.8.3.min.js"></script>
<script>
    $(function(){
                ...
                <% for (var i = 0, len = photos.length; i < len; i++) { %>
                    <% var my_album = photos[i]; %>                   
                        <a href="<%- my_album.img_url %>" data-caption="<%- my_album.title %>">
                            ...
                            <!-- <img class="mat" src="<%- my_album.img_url %>"  alt="img"+<%- i %> > -->
                        </a>                   
                <% } %>
            <% } %>
            </div>
