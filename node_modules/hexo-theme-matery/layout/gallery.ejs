...
<main class="content">
        ...
        <div class="card bgi">
            <div class="card-content">
                <div class="tag-title center-align">
                    <div class="miaoshus">
                        <strong><div class="title center-align">“ <%- theme.gallery.title %> ”</div></strong>
                        <span><strong>“ 这里有光影流年，还有两朵穿衣裳的云，相拥在明天的河岸 ” </strong></span>               
                    </div>
                </div>
    ...
    <script>
        $('.bg-cover').css('background-image', 'url(<%- theme.jsDelivr.url %><%- url_for('/medias/banner/3.jpg') %>)');
    </script>
</main>
